...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 bg-gradient-to-r from-gray-900 to-gray-800 overflow-hidden">
      <div className="absolute inset-0 bg-cyan-900/10 mix-blend-multiply"></div>
      <div className="absolute inset-0 bg-[url('/api/placeholder/1200x800')] bg-cover bg-center opacity-10"></div>
