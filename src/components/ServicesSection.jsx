  ...
  return (
    <div className="bg-black py-16 px-4">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-base md:base lg:base font-bold mb-2 bg-gradient-to-b from-[#2FBECE] to-[#2974B7] bg-clip-text text-transparent">Our Services</h2>
          <h1 className="text-lg md:text-2xl text-white leading-relaxed tracking-[2px] font-bold ">Our Palette Of Expertise</h1>
        </motion.div>
        <motion.div 
      ...
      <Link to="/servicepage" className='group relative overflow-hidden flex items-center lg:mt-12 lg:px-4 lg:py-3 md:mt-12 md:px-4 md:py-3 mt-7 px-4  py-3  text-black rounded-3xl bg-[linear-gradient(182deg,_#FFF_1.76%,_rgba(255,255,255,0.8)_98.24%)] transition-all duration-500 ease-in'> 
