...
export default function SingleBlogPage2() {

  const location = useNavigate();

  const relatedArticles = [
    { title: "Article Name – Headline of an Article", author: "Author Name", image: comp1 , height: false},
    { title: "Article Name – Headline of an Article", author: "Author Name", image: b3 , height: true},
    { title: "Article Name – Headline of an Article", author: "Author Name", image: b2 ,height: false},
  ...
  return (
    <div className="bg-black/90 text-white  lg:mx-auto md:mx-auto w-full mx-0    font-sans">
      {/* Back */}
      ...
      <div className="w-full rounded-2xl overflow-hidden shadow-[0_10px_25px_rgba(0,0,0,0.6)] mb-8">
        <img src={b1} alt="Main" className="w-full h-[250px] sm:h-[350px] md:h-[420px] object-cover rounded-2xl" />
      </div>
