  ...
  return (
    ...
    <div className="w-full h-full snap-none ">
          ...
          <video
            ...
            playsInline
          >
            <source src="https://res.cloudinary.com/dzbuyze8t/video/upload/v1738315886/digitalm_x6magj.mp4" type="video/mp4" />
          ...
          <div className=" z-10 flex mx-auto items-center mt-24 justify-end flex-col w-full h-full mb-[92px] px-4 ">
            ...
            <div className="flex flex-col items-center max-w-7xl h-full  text-center lg:h-[400px] md:h-[400px] backdrop-blur-sm snap-y bg-white/70 p-6 sm:p-10 rounded-lg shadow-lg">
              ...
              Boost your business with our digital marketing services. We assist in boosting your online visibility, attracting the right audience, and increasing sales through SEO, social media efforts, and targeted strategies. Allow us to formulate a plan that generates tangible outcomes for your brand.
