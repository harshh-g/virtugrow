  ...
  return (
    ...
    <div className="w-full h-full snap-none ">
          ...
          <video
            ...
            playsInline
          >
            <source src="https://res.cloudinary.com/dzbuyze8t/video/upload/v1738315887/web_nn5eru.mp4" type="video/mp4" />
          ...
          <div className=" z-10 flex mx-auto items-center mt-24 justify-end flex-col w-full h-full mb-[92px] px-4 ">
            ...
            <div className="flex flex-col items-center max-w-7xl h-full  text-center lg:h-[400px] md:h-[400px] backdrop-blur-sm snap-y bg-white/70 p-6 sm:p-10 rounded-lg shadow-lg">
              ...
              Create a great digital identity with Virtugrow Digital, the top web development company in Lucknow. Our team develops user friendly, responsive websites which are visually appealing and highly effective and are customized for business. From custom websites to online stores, we make sure that your online presence is helping you grow and your online presence is being noticed in the digital world. Choose our company Virtugrow Digital for a website that produces real results
              </p>
            </div>
